...
--correct  : 3D94E99F-0B54-4A6C-8A00-4B5A57A6C78A  (KREATIF MANTAP SDN. BHD.) --modification_info = '40240123-F699-4EA6-B8BF-F3DF2427ED8C'
--wrong    : AB430777-C34C-4E37-8E44-913C35AF2BF4  (KREATIF MANTAP SDN BHD  ) --modification_info = '139B2763-3F30-4AF8-A7BC-3D25DCEB274C'

--SELECT * FROM KETUPAT_FE.DBO.ENTITY WHERE ACTIVE_NAME LIKE '%KREATIF MANTAP%'
-----------------------------------------------------------------------------------------------------------------
DECLARE  @correct_guid uniqueidentifier = '3D94E99F-0B54-4A6C-8A00-4B5A57A6C78A'
		,@wrong_guid uniqueidentifier	= 'AB430777-C34C-4E37-8E44-913C35AF2BF4'
